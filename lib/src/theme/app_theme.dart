...
class AppTheme {
  ...
  primary: Color(0xFFA9C6B9), // Muted turquoise
  secondary: Color(0xFFFDD8C7), // Dark gray
  surface: Color(0xFF424242), // Slightly lighter than background
  onPrimary: Colors.white, // White text on primary
  onSecondary: Colors.black, // White text on background
  onSurface: Colors.white, // White text on surface
  error: Color(0xFFEFDAB2), // Warm beige (for warnings or positive actions)
